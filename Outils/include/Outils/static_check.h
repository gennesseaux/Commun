...
// $Header: /cvsroot-fuse/loki-lib/loki/include/loki/static_check.h,v 1.3 2006/01/16 19:05:09 rich_sposato Exp $
...
#define STATIC_CHECK(expr, msg) \
    { Outils::CompileTimeError<((expr) != 0)> ERROR_##msg; (void)ERROR_##msg; } 
